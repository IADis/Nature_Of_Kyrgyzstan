...
class AlaArchaDetailScreen extends StatefulWidget {
  const AlaArchaDetailScreen({super.key, required this.documentSnapshot});
  final DocumentSnapshot documentSnapshot;

  @override
  State<AlaArchaDetailScreen> createState() => _AlaArchaDetailScreenState();
}

class _AlaArchaDetailScreenState extends State<AlaArchaDetailScreen> {
