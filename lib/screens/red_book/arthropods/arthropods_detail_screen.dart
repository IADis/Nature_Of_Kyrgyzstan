...
class ArthropodsDetailScreen extends StatefulWidget {
  ...
  @override
  State<ArthropodsDetailScreen> createState() => _ArthropodsDetailScreenState();
}

class _ArthropodsDetailScreenState extends State<ArthropodsDetailScreen> {
          ...
          SliverAppBarLarge(
            ...
            images: [
              RedBookPageViewImages(
                image: data['image'],
                data: data['image'],
                pageViewCircularColor: AppColors.arthropodsColors,
              ),
              RedBookPageViewImages(
